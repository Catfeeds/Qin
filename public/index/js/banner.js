...
$(document).ready(function(){
  $(".statistics_tab_01").click(function(){
    $(".statistics_tab_01").addClass("dangqian");
	$(".statistics_tab_02").removeClass("dangqian");
	$(".statistics_tab_03").removeClass("dangqian");
	$(".statistics_tabContent_01").css("display","block");
	$(".statistics_tabContent_02").css("display","none");
	$(".statistics_tabContent_03").css("display","none");
  });
   $(".statistics_tab_02").click(function(){
    $(".statistics_tab_02").addClass("dangqian");
	$(".statistics_tab_01").removeClass("dangqian");
	$(".statistics_tab_03").removeClass("dangqian");
	$(".statistics_tabContent_02").css("display","block");
	$(".statistics_tabContent_01").css("display","none");
	$(".statistics_tabContent_03").css("display","none");
  });
    $(".statistics_tab_03").click(function(){
    $(".statistics_tab_03").addClass("dangqian");
	$(".statistics_tab_02").removeClass("dangqian");
	$(".statistics_tab_01").removeClass("dangqian");
	$(".statistics_tabContent_03").css("display","block");
	$(".statistics_tabContent_02").css("display","none");
	$(".statistics_tabContent_01").css("display","none");
  });
});
