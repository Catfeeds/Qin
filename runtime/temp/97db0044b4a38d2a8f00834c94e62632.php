<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\juris\update.html";i:1490841564;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li onclick="javascript:window.location.href='<?php echo url('juris/index'); ?>'">权限列表</li>
...
<form class="layui-form" action="" id="fid" method="post">
 ...
 <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="page" lay-filter="page" required lay-verify="required" placeholder="请输入页码" value="<?php echo $jobj['pagination']; ?>" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
