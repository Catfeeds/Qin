<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/index/user.html";i:1495432132;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<section>
	<ul class="uMyList <?php if($obj['id'] != \think\Session::get('m_user_auth.id')): ?>Cndy<?php endif; ?>">
		<li class="myForum">
			<a data-bn-ipg="musercenter-navigate-mybbs" href="<?php if($obj['id'] == \think\Session::get('m_user_auth.id')): ?>/wap/user/info.html<?php else: ?>#<?php endif; ?>">
				<span>基本信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $obj['user_sex']; ?>&nbsp;&nbsp;<?php echo $obj['user_age']; ?>岁&nbsp;&nbsp;<?php echo $obj['pname']; ?>-<?php echo $obj['cname']; ?></span>
			</a>
		</li>
		<?php if($obj['sid']!=0): ?>
        ...
        <li class="myBudget">
        	<a data-bn-ipg="musercenter-navigate-myz" href="<?php if($obj['id'] == \think\Session::get('m_user_auth.id')): ?>/wap/user/index_player.html<?php else: ?>#<?php endif; ?>">
        		<span>参赛大类<?php if(is_array($plist) || $plist instanceof \think\Collection || $plist instanceof \think\Paginator): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['type_name']; if($vo['maxid']!=0): ?>/<?php echo $vo['maxname']; endif; endforeach; endif; else: echo "" ;endif; ?></span>
        	</a>
        </li>
        <li class="myCoupon">
        	<a data-bn-ipg="musercenter-navigate-myz" href="<?php if($obj['id'] == \think\Session::get('m_user_auth.id')): ?>/wap/user/index_player.html<?php else: ?>#<?php endif; ?>">
        		<span>节目名称<?php if(is_array($plist) || $plist instanceof \think\Collection || $plist instanceof \think\Paginator): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['wname']; endforeach; endif; else: echo "" ;endif; ?></span>
        	</a>
        </li>
        <?php endif; ?>
        <li class="fanshop" style="min-height:75px;">
        	<a data-bn-ipg="musercenter-navigate-fanshop" style="height: 100%;" href="<?php if($obj['id'] == \think\Session::get('m_user_auth.id')): ?>/wap/user/photo.html<?php else: ?>#<?php endif; ?>">
        		<span style="height: 40px;">个人相册</span>
        ...
        <li class="manage">
        	<a data-bn-ipg="musercenter-navigate-manage" href="<?php if($obj['id'] == \think\Session::get('m_user_auth.id')): ?>/wap/user/guestbook.html<?php else: ?>#<?php endif; ?>">
	  ...
	  <ul class="liuyan">
		<?php if(is_array($list_gb_json) || $list_gb_json instanceof \think\Collection || $list_gb_json instanceof \think\Paginator): $i = 0; $__LIST__ = $list_gb_json;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			...
			<a href="<?php echo url('index/user',['user_id'=>$vo['user_id']]); ?>">
				...
				<p class="switchStyle">
				<span class="current"><?php echo $vo['content']; ?></span>
				</p>  
