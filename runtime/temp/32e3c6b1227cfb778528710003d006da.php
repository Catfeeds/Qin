<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/player.html";i:1495609768;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1495357736;}*/ ?>
		  ...
		  <div class="layui-form-item" style="<?php if($obj['maxid']!=0): ?>display:block;<?php else: ?>display:none;<?php endif; ?>">
			  ...
			  <div class="layui-form-item" pane>
				...
				<div class="layui-input-block">
					...
					<input type="radio" lay-filter="adi" name="tp" value="0" title="社会" <?php if(($obj['back_4']==1&&$obj['sid']==0)): ?>checked<?php endif; ?>>
				</div>
			  </div>
			  <div class="layui-form-item">
			  ...
			  <div class="layui-form-item" id="school_id" style="display:<?php if(($obj['back_4']==1&&$obj['sid']==0)): ?>block<?php else: ?>none<?php endif; ?>;">
				...
				<div class="layui-input-block">
				  <input type="text" name="school_name" value="<?php echo $obj['sname']; ?>" placeholder="请输入所属学校名称" required lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item">
				<label class="layui-form-label">所属详细</label>
				<div class="layui-input-block">
				  <input type="text" name="unit" placeholder="请输入所属学校的院,系,级信息"  value="<?php echo $obj['unit']; ?>" required lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item">
