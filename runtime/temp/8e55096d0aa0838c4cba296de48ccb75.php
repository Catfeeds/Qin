<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\activity\index.html";i:1492834304;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('activity/insert'); ?>'">添加活动</li>
  </ul>
</div> 
<blockquote class="layui-elem-quote layui-quote-nm">
<label class="layui-form-label">搜索：</label>
<form action="<?php echo url('',['page'=>1]); ?>" class="layui-form" method="post"  >
<input type="text" name="title" id="stxt" style="width:360px;float:left;" required lay-verify="required" placeholder="活动标题" class="layui-input">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['tid'] != 0)): ?><?php echo $vo['tname']; else: ?>所有社团<?php endif; ?></td>
	  <td><?php if(($vo['pid'] != 0)): ?><?php echo $vo['pname']; else: ?>所有地区<?php endif; if(($vo['cid'] != 0)): ?>-<?php echo $vo['cname']; endif; if(($vo['sid'] != 0)): ?>-<?php echo $vo['sname']; endif; ?></td>
      ...
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('activity/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('activity/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
