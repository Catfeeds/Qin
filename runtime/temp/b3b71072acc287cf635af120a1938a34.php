<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\qnysj1\wwwroot/app/index/view/live/index_user.html";i:1499416860;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>青年文化艺术节-<?php echo \think\Session::get('gjz.title'); ?></title>
...
<link rel="stylesheet" type="text/css" href="__STATIC__/layui/css/layui.css" />
	...
	<style>
		dd{width:55px;overflow: hidden; text-overflow:ellipsis; white-space: nowrap;}
		dl{width:55px;overflow: hidden; text-overflow:ellipsis;white-space: nowrap;}
	</style>
	...
	<div class="class_content">
		<div class="class_contnet_left">
			<div class="class_nav">
				<ul>
					<li><a href="/index/live/index.html">赛事直播</a></li>
					<li><a href="/index/live/index_user.html" class="dangqian">选手直播</a></li>
				</ul>
			</div>
		...
		<div class="class_contnet_right">
			...
			<div class="live_player" id="pg">
				...
				<?php if(is_array($list_user_live_back_3) || $list_user_live_back_3 instanceof \think\Collection || $list_user_live_back_3 instanceof \think\Paginator): $i = 0; $__LIST__ = $list_user_live_back_3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li><a href="<?php echo $vo['Live']; ?>"><img src="<?php echo $vo['img']; ?>" width="179" height="137" /></a></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="live_player_more">
				<div class="player_more_title">				
					...
					<a href="/index/live/index_user.html" style="color: #e32024;font-size: 18px;">选手直播</a>
					<a href="/index/live/index.html" style="color: #5a5858;font-size: 18px;padding-left: 10px;">赛事直播</a>
				</div>
				<div class="player_more_list">
					<ul>
						...
						<li>
							<a href="<?php echo $vo['Live']; ?>"><img src="<?php echo $vo['img']; ?>" width="164" height="164" /></a>
							<dt><a href="<?php echo $vo['Live']; ?>"><?php echo $vo['back_3']; ?></a></dt>
							<dd><?php echo $vo['user_name']; ?></dd>
							<dl><?php echo $vo['sname']; ?></dl>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
