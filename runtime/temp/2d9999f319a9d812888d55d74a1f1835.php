<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/media/index.html";i:1494216244;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		...
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item mui-active" href="<?php echo url('Media/index'); ?>">校园院报</a>
				<a class="mui-control-item" href="<?php echo url('Media/index2'); ?>">校园之声</a>
			</div>
		</div>
