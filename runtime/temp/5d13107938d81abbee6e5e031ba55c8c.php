<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\wwwroot\qnysj1\wwwroot/app/index/view/lists/index_player.html";i:1500780828;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>热门选手排行-<?php echo \think\Session::get('gjz.title'); ?></title>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
            	<li><a href="<?php echo url('lists/index'); ?>">校园排行</a></li>
				<li><a href="<?php echo url('lists/index_player'); ?>" class="dangqian">选手排行</a></li>
...
<div id="full-screen-slider04">
	<ul id="slides04">
		<li style="background:url(/public/index/images/b_01.jpg) no-repeat center top;background-size:cover;"><a href="#" target="_blank">01</a></li>
	</ul>
</div>
<!-- 代码 结束 -->
        </div>
        
        <div class="school_introduce">热门选手排行...</div>
        <div class="live_player_more">
        	<div class="player_more_title">
            	<?php echo $list_player->render(); ?>
				<a style="color: #e32024;font-size: 18px;">热门选手展示</a>
				<a href="<?php echo url('lists/index'); ?>"  style="color: #5a5858;font-size: 18px;">校区报名展示</a>
				<a href="<?php echo url('lists/index_cmm'); ?>"  style="color: #5a5858;font-size: 18px;">社区报名展示</a>
            </div>
            <div class="player_more_list">
            	<ul>
					<?php if(is_array($list_player) || $list_player instanceof \think\Collection || $list_player instanceof \think\Paginator): $i = 0; $__LIST__ = $list_player;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<li>
                    	<a href="<?php echo url('user/index',['user_id'=>$vo['id']]); ?>"><img src="<?php echo $vo['img']; ?>" width="164" height="164" /></a>
                        <dt style="width: 50%;">
						<a href="#">
						支持:<?php echo $vo['back_3']; ?>
						</a>
						</dt>
