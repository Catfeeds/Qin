<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\wwwroot\wchhui1\wwwroot/app/index/view/school/index.html";i:1497431028;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>校区集锦-<?php echo cookie('remark')['title']; ?></title>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
                <li><a href="<?php echo url('school/index'); ?>" class="dangqian">醉美校园</a></li>
				<li><a href="<?php echo url('school/index_news'); ?>">热点时讯</a></li>
            </ul>
        </div>
...
<ul id=idSlider class=slider>
  ...
  <?php if(is_array($list_school) || $list_school instanceof \think\Collection || $list_school instanceof \think\Paginator): $i = 0; $__LIST__ = $list_school;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	<div style="POSITION: relative">
		  <a href="<?php echo url('school/school_info',['school_id'=>$vo['id']]); ?>" target="_blank"><img src="<?php echo $vo['img']; ?>" width=900 height=330></a>
	 </div>
  <?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- 代码 结束 -->
		...
		<?php if(is_array($list_school) || $list_school instanceof \think\Collection || $list_school instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($list_school) ? array_slice($list_school,1,1, true) : $list_school->slice(1,1, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

		<div class="school_introduce"><?php echo $vo['esc']; ?>... <a href="<?php echo url('school/school_info',['school_id'=>$vo['id']]); ?>" target="_blank">[详细]</a></div>
		
		<?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="school_more">
        	<div class="school_more_title">
            	<?php echo $list_all->render(); ?>
            	<a href="<?php echo url('school/index'); ?>" style="color: #e32024;font-size: 18px;" >醉美校园</a>
				<a href="<?php echo url('school/index_news'); ?>" style="color: #5a5858;font-size: 18px;padding-left: 10px;">热点时讯</a>
            </div>
            <div class="school_more_list">
            	<ul>
                	...
                	<li>
                    	<a href="<?php echo url('school/school_info','school_id='.$vo['id']); ?>"><img src="<?php echo $vo['img']; ?>" width="296" height="150" /></a>
						<a class="add_s" href="<?php echo url('school/school_info','school_id='.$vo['id']); ?>" style="background-color: #5f686999;position: relative;margin-top: -20px;text-align: center;color: #fff;"><?php echo $vo['name']; ?></a>
                    </li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
               	</ul>
            </div>
