<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\module\index.html";i:1493178433;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li class="layui-this">社团列表</li>
    <li onclick="javascript:window.location.href='<?php echo url('module/insert'); ?>'">添加社团</li>
  </ul>
</div> 
<blockquote class="layui-elem-quote layui-quote-nm">
<label class="layui-form-label">搜索：</label>
<form action="<?php echo url('',['page'=>1]); ?>" class="layui-form" method="post"  >
<input type="text" name="title" id="stxt" style="width:360px;float:left;" required lay-verify="required" placeholder="社团名称" class="layui-input">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['pid'] != 0)): ?><?php echo $vo['pname']; else: endif; if(($vo['cid'] != 0)): ?>-<?php echo $vo['cname']; endif; if(($vo['sid'] != 0)): ?>-<?php echo $vo['sname']; endif; ?></td>
	  <td><?php if(($vo['status'] == 1)): ?><a>已审核</a><?php elseif(($vo['status'] == 2)): ?><a>新申请</a><?php else: ?><a>未审核</a><?php endif; ?></td>
	  <td style="color:#00aa00;"><?php if($vo['back_1']==1): ?>首页推荐<?php endif; ?>&nbsp;<?php if($vo['back_2']==1): ?>分类推荐<?php endif; ?></td>
	  <td><?php echo date("y-m-d h:s",$vo['add_time']); ?></td>
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('module/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
			  <a href="<?php echo url('module/art_list',['id'=>$vo['id']]); ?>" class="layui-btn">动态</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('module/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
