<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\cate\index.html";i:1491626768;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li class="layui-this">资讯分类列表</li>
    <li onclick="javascript:window.location.href='<?php echo url('cate/insert'); ?>'">添加分类</li>
  </ul>
</div> 
    ...
    <tr>
      ...
      <td >
		<dl class="layui-btn-group">
		  <a href="<?php echo url('cate/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
