<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/activity/index.html";i:1494392522;s:58:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/public/base.html";i:1496904694;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('activity/insert'); ?>'">添加资讯</li>
  </ul>
</div> 
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['status'] == 1)): ?><a>启用</a><?php elseif(($vo['status'] == 2)): ?><a>新投稿</a><?php else: ?><a>冻结</a><?php endif; ?></td>
