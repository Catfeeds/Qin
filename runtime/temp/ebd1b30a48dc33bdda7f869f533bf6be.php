<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/login/wx_login.html";i:1495268542;}*/ ?>
<!DOCTYPE html>
	...
	<body>
		...
		<div class="mui-content">
			...
			<div class="mui-content-padded">
				<button id='login' data-loading-text="绑定中" class="mui-btn mui-btn-block mui-btn-primary">绑定</button>
				<div class="link-area"><a id='reg' href="<?php echo url('Login/wx_reg'); ?>" >生成新账号</a> <span class="spliter">|</span><a id='index' href="<?php echo url('index/index'); ?>">返回官网</a>
				</div>
			</div>
		...
		<script>
			...
			document.getElementById("login").addEventListener("click", function(){
				...
				if(check){
					...
					//ajax交互，进行登录
					mui.post('<?php echo url('Login/wx_login'); ?>',{
