<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/report/index_com.html";i:1500630838;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
      <th><?php echo $i; ?></th>
      <td><?php echo $vo['gb_content']; ?></td>
	  <td><?php echo $vo['wname']; ?></td>
	  <td><?php echo $vo['report']; ?></td>
	  <td><?php echo $vo['user_name']; ?></td>
	  <td><?php echo date("y-m-d h:s",$vo['add_time']); ?></td>
	  <td><?php if(($vo['status'] == 0)): ?><a style="color:#ff0000;">未处理</a><?php else: ?><a>已处理</a><?php endif; ?></td>
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('report/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('report/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
