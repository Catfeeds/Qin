<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\activity\activity_info.html";i:1493139102;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493139429;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="box_lef lef">
			...
			<div class="box_shux">
				<ul class="activity">
					<li class=""><a href="<?php echo url('news/index',['type_id'=>1]); ?>">赛事时讯</a></li>
					<li class="cli"><a href="<?php echo url('news/index',['type_id'=>2]); ?>">活动公告</a></li>
				</ul>
				<div class="sign_up1">
	...
	<div class="box_rig rig">
		<div class="acti">
			...
			<ul class="acti_cen_lef_list">
				...
				<li><a class="lef" href="<?php echo url('news/News_info',['news_id'=>$vo['id']]); ?>"><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; ?></a></li>
				<li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<div class="col_act">
				<div class="col_act_tit"><?php echo $obj['title']; ?></div>
				<div class="seeding_texttatle"><span>文章来源：<?php echo $obj['edit']; ?></span><span>添加时间：<?php echo date('Y-m-d',$obj['add_time']); ?></span><span>活动类别：<?php echo $obj['tname']; ?></span></div>
