<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/index/index.html";i:1494561182;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
		...
		<div id="full-screen-slider">
			<ul id="slides">
				<?php if(is_array($list_activity_2) || $list_activity_2 instanceof \think\Collection || $list_activity_2 instanceof \think\Paginator): $i = 0; $__LIST__ = $list_activity_2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$io): $mod = ($i % 2 );++$i;?>
					<li style="background:url(<?php echo $io['img']; ?>) no-repeat center top;background-size:cover;"><a href="<?php echo url('media/news_info',['news_id'=>$io['id']]); ?>" target="_blank"><?php echo $io['id']; ?></a></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	<!-- 代码 结束 -->
