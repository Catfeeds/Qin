<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\school\index_news.html";i:1493097750;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493139429;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
 ...
 <style>
		...
		.new_banner{width: 734px;height: 230px;margin-bottom: 25px;overflow: hidden;position: relative;}
	...
	<div class="box_rig rig">
		<div class="acti">
			...
			<div class="eve_reg frl">
						<?php if(is_array($list_news_t) || $list_news_t instanceof \think\Collection || $list_news_t instanceof \think\Paginator): $i = 0; $__LIST__ = $list_news_t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<li><?php echo $vo['esc']; ?></li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
			...
			<ul class="bri_int">
				...
				<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($list_all) ? array_slice($list_all,0,3, true) : $list_all->slice(0,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
					...
					<div class="bri_int_lef_t<?php if($k == '1'): ?>it<?php endif; ?>">
						<a class="lef" href="<?php echo url('school/News_info',['news_id'=>$vo['id']]); ?>">
				...
				<?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<div class="bri_int_rig"><a href="<?php echo url('school/News_info',['news_id'=>$list_all[0]['id']]); ?>"><img src="<?php echo $list_all[0]['img']; ?>"/></a></div><?php endif; ?>
				</li>
				...
				<?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<div class="bri_int_rig"><a href="<?php echo url('school/News_info',['news_id'=>$list_all[3]['id']]); ?>"><img src="<?php echo $list_all[3]['img']; ?>"/></a></div><?php endif; ?>
				</li>
				...
				<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a></div>
					...
					<div class="bri_int_rig"><a href="<?php echo url('school/News_info',['news_id'=>$list_all[3]['id']]); ?>"><img src="<?php echo $list_all[6]['img']; ?>"/></a></div><?php endif; ?>
				</li>
				...
				<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a></div>
					...
					<div class="bri_int_rig"><a href="<?php echo url('school/News_info',['news_id'=>$list_all[9]['id']]); ?>"><img src="<?php echo $list_all[9]['img']; ?>"/></a></div><?php endif; ?>
				</li>
			</ul>
		</div>
	</div>
