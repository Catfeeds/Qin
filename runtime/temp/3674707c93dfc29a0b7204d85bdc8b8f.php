<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/user/msg.html";i:1494327808;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<script type="text/javascript" charset="utf-8">
		...
		$('#ajax_msg_return').on('tap', '.mui-btn', function(event) {
			...
			mui.confirm('确认删除该条记录？', '通知信息', btnArray, function(e) {
				if (e.index == 0) {
					...
					mui.ajax('<?php echo url('User/msg_del'); ?>',{
						data:{id:id},
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('User/msg'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
