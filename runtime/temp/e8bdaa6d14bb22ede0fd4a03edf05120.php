<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/news/update.html";i:1498789216;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li onclick="javascript:window.location.href='<?php echo url('news/index'); ?>'">资讯列表</li>
    <li class="layui-this">修改资讯</li>
  </ul>
</div> 
...
<input type="hidden" name="aid" value="<?php echo $nobj['id']; ?>">
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="aname" lay-filter="aname" required lay-verify="required" placeholder="请输入账号" value="<?php echo $nobj['title']; ?>" autocomplete="off" class="layui-input">
    </div>
  </div>
   <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <select name="pid" required lay-verify="required" style="width:200px;">
		 ...
		 <?php if(is_array($alist) || $alist instanceof \think\Collection || $alist instanceof \think\Paginator): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<option value="<?php echo $vo['id']; ?>"  <?php if($nobj['maxtype_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
  ...
  <div class="layui-form-item" style="width:600px">
	...
	<div class="layui-input-block" id="id_img">
		<img style="width:200px" src="<?php echo $nobj['img']; ?>"/>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">发布者</label>
    <div class="layui-input-block">
      <input type="text" name="edit" lay-filter="edit" value="<?php echo $nobj['edit']; ?>" autocomplete="off" class="layui-input" >
    </div>
  </div>
   <div class="layui-form-item" style="width:600px">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <textarea name="keywords" placeholder="请输入关键字" class="layui-textarea"><?php echo $nobj['keywords']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">页面描述</label>
    <div class="layui-input-block">
      <textarea name="description" placeholder="请输入描述" class="layui-textarea"><?php echo $nobj['description']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">资讯简介</label>
    <div class="layui-input-block">
      <textarea name="esc" placeholder="请输入简介" class="layui-textarea"><?php echo $nobj['esc']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:800px">
    <label class="layui-form-label">资讯内容</label>
    <div class="layui-input-block">
      <textarea id="content" name="content"><?php echo $nobj['content']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
	  <input type="hidden" name="checks" id="checks" value="0">
       <input type="checkbox" name="check[]" <?php if($nobj['back_1']==1): ?>checked<?php endif; ?>  value="1" lay-filter="check1" title="首页推荐" >
	   <input type="checkbox" name="check[]" <?php if($nobj['back_2']==1): ?>checked<?php endif; ?>  value="2" lay-filter="check1" title="分类推荐" >
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">启用</label>
    <div class="layui-input-block">
	  <input type="hidden" name="stch" id="stch" value="<?php echo $nobj['status']; ?>"> 
      <input type="checkbox" lay-text="yes|no" lay-filter="stch" value="1" name="switch" <?php if(($nobj['status'] == 1)): ?>checked<?php endif; ?> lay-skin="switch">
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
