<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\user\index.html";i:1492890996;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493139429;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<div class="acti">
			<div class="inf">
				...
				<ul class="inf_rig lef">
					<li>姓名：<?php echo $obj['user_name']; ?></li>
					<li>性别：<?php echo $obj['user_sex']; ?></li>
					<li><?php echo $obj['pname'].$obj['cname'].$obj['sname']; ?></li>
				</ul>
			</div>			
			<div class="com">
				...
				<div class="dyn">
					<div class="nic"><a href="<?php echo url('index/user/art_info',['user_id'=>input('user_id'),'art_id'=>$vo['id']]); ?>"><?php echo $vo['content']; ?></a></div>
					<div class="con">
						<div class="tim lef"><?php echo date('Y-m-d H:i:s',$vo['add_time']); ?></div>
						<div class="con_rig rig"><i class="icon">&#xe681;</i><em><?php echo $vo['com_number']; ?></em></div>
						<div class="con_rig rig"><i class="icon">&#xe621;</i><em><?php echo $vo['look']; ?></em></div>
					</div>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
