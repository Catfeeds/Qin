<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/adm/index.html";i:1494994530;s:64:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/public/base.html";i:1494998636;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['pid'] != 0)): ?><?php echo $vo['pname']; else: ?>all<?php endif; if(($vo['cid'] != 0)): ?>-<?php echo $vo['cname']; endif; if(($vo['sid'] != 0)): ?>-<?php echo $vo['sname']; endif; ?></td>
      ...
      <td >
		<dl class="layui-btn-group">
		  <a href="<?php echo url('adm/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
		  <!--<a href="<?php echo url('adm/edit',['id'=>$vo['id']]); ?>" class="layui-btn">权限</a>-->
