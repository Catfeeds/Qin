<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/maintain/index.html";i:1498789478;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="layui-form-item" style="width:600px">
   ...
   <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
	  ...
	  <textarea name="keyword" placeholder="请输入关键字" class="layui-textarea"><?php echo $obj['keyword']; ?></textarea>
    </div>
  </div>
   <div class="layui-form-item" style="width:600px">
