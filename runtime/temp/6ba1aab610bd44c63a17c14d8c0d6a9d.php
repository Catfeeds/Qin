<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/index_player.html";i:1495172580;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1496803634;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">报名信息(<span><?php echo count($plist); ?></span>)</li>
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
            ...
            <li >
			  ...
			  <a href="<?php echo url('usercontrol/player',['player_id'=>$vo['id']]); ?>" target="_blank" >
...
function del(id)
	{
		layer.confirm('删除之后不可恢复，是否继续执行？', {
		  ...
		  btn1:function(index, layero){
				$.ajax({
				url:"<?php echo url('usercontrol/player_del'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
