<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\user\gb_index.html";i:1492924303;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1492917550;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<style>
	...
	<div class="box_shux">
		<ul class="activity" style="padding: 10px 20px;">
			...
			<li class="cli"><a href="<?php echo url('index/user/gb_index',['user_id'=>input('user_id')]); ?>">留言板</a></li>
		</ul>
		<div class="sign_up1">
	...
	<div class="box_rig rig" style="position: relative;">
		<div class="acti">
			<div class="journalism_tit" style="border-bottom: 1px solid #000;margin-bottom: 20px;">
				<span class="lef">留言板</span>
			</div>
			<div class="pub">
				<form action="" method="post" id="plhf" class="layui-form">
				<input type="hidden" id="uid" name="uid" value="<?php echo $obj['id']; ?>">
				<textarea name="content" class="layui-textarea" placeholder="说点什么吧"></textarea>
				<input type="button" class="layui-btn" value="发布" style="float:right;" lay-filter="sbt" lay-submit/>
				</form>
			</div>
			<div class="com">
				...
				<div class="dyn">
					<div class="nic"><?php echo $vo['content']; ?></div>
					<div class="con">
						<div class="tim lef"><?php echo date('Y-m-d H:i',$vo['add_time']); ?></div>
					</div>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
