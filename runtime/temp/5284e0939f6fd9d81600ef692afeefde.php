<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/broadcast/update.html";i:1498791534;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li onclick="javascript:window.location.href='<?php echo url('broadcast/index'); ?>'">直播列表</li>
    <li class="layui-this">修改直播</li>
  </ul>
</div> 
...
<input type="hidden" name="aid" value="<?php echo $nobj['id']; ?>">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <textarea name="url" placeholder="请输入直播跳转链接"  value="<?php echo $nobj['url']; ?>" class="layui-textarea"> <?php echo $nobj['url']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
  ...
  <div class="layui-form-item" style="width:800px;display:none;">
