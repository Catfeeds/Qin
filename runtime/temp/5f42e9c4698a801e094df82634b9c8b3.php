<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/module_index.html";i:1496802726;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1496552374;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">投稿信息（<span><?php echo count($list_record); ?></span>）</li>
		<li data-type="mine-jie" lay-id="index" ><a href="<?php echo url('usercontrol/module_add'); ?>">我要投稿</a></li>
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
            ...
            <li >
              ...
              <a href="<?php echo url('media/news_info',['news_id'=>$vo['id']]); ?>" target="_blank"><?php echo $vo['title']; ?></a>

              <em style="padding-right: 100px;"><?php echo date('Y-m-d h:s',$vo['add_time']); ?></em>
			  <em><a href="<?php echo url('usercontrol/module_xlx',['module_id'=>$vo['id']]); ?>" style="color: #99aacb;">修改</a></em>
            </li>
			<?php endforeach; endif; else: echo "" ;endif; ?>

          </ul>
          <div id="LAY_page">
			<?php echo $list_record->render(); ?>
		  </div>
        </div>
...
function del(id)
	{
		layer.confirm('删除之后不可恢复，是否继续执行？', {
		  ...
		  btn1:function(index, layero){
				$.ajax({
				url:"<?php echo url('usercontrol/module_del'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
