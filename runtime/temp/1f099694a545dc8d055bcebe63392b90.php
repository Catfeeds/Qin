<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\usercontrol\photo.html";i:1492583760;s:67:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\ModelBase.html";i:1493095052;}*/ ?>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        ...
        <div class="layui-tab-item layui-show">
			<?php if(is_array($list_hpoto) || $list_hpoto instanceof \think\Collection || $list_hpoto instanceof \think\Paginator): $i = 0; $__LIST__ = $list_hpoto;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			  <div class="div_img">
				<p style="height: 195px;"><img src='<?php echo $vo['img']; ?>' /></p>
