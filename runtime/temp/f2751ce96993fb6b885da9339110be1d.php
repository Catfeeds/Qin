<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\activity\add.html";i:1492359173;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492584676;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="" method="post" id="fid" enctype="multipart/form-data">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="edit" lay-filter="edit" required lay-verify="required" placeholder="请输入活动发起人" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
