<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/message.html";i:1497164878;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1497237796;}*/ ?>
...
<head>
  <meta charset="utf-8">
  <title>
  通知管理-<?php echo cookie('remark')['title']; ?></title>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">通知消息（<span><?php echo count($list_message); ?></span>）</li>
      </ul>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
			<?php if(is_array($list_message) || $list_message instanceof \think\Collection || $list_message instanceof \think\Paginator): $i = 0; $__LIST__ = $list_message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li >
			  <?php if(($vo['look'] == 0)): ?>
			  <a href="javascript:;" onclick="update(<?php echo $vo['id']; ?>)"><i class="layui-icon" style="color: #00EE00;font-size: 25px;">&#xe623;</i></a>
			  <?php else: ?>
			  <a href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)"><i class="layui-icon" style="font-size: 25px;">&#x1006;</i></a>
			  <?php endif; ?>
			   <a href="<?php echo url('usercontrol/message_info',['message_id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a>
...
function del(id)
	{
		layer.confirm('删除之后不可恢复，是否继续执行？', {
		  ...
		  btn1:function(index, layero){
				$.ajax({
				url:"<?php echo url('usercontrol/message_del'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
...
function update(id)
	{
		$.ajax({
				url:"<?php echo url('usercontrol/message_update'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
