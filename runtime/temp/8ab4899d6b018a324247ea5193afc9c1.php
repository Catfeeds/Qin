<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/school/news_info.html";i:1497777572;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<style>
	...
	<div class="mui-content">
		<div class="mui-card">
			<div class="mui-card-header"><?php echo $obj['title']; ?></div>
			<div class="mui-card-content">
				<div class="mui-card-content-inner">
					<p>
						<span>来源：<?php echo $obj['edit']; ?></span>
						<span>时间：<?php echo date('Y-m-d',$obj['add_time']); ?></span>
						<span>分类：<?php echo $obj['maxtype_name']; ?></span>
						<span>浏览：<?php echo $obj['look']; ?></span>
					</p><hr/>
					<p style="color: #333;"><?php echo $obj['content']; ?></p>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript" charset="utf-8">
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('school/index2'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
