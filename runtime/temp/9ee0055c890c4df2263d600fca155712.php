<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\juris\index.html";i:1491626776;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('juris/insert'); ?>'">添加权限</li>
  </ul>
</div> 
<blockquote class="layui-elem-quote layui-quote-nm">
<label class="layui-form-label">搜索：</label>
<form action="<?php echo url('',['page'=>1]); ?>" class="layui-form" method="post"  >
<input type="text" name="title" id="stxt" style="width:360px;float:left;" placeholder="权限名称" class="layui-input">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php if($vo['pid'] == ''): ?>一级权限<?php else: ?>二级权限<?php endif; ?></td>
	  <td><?php echo $vo['pagination']; ?></td>
      ...
      <td >
		<dl class="layui-btn-group">
		  <a href="<?php echo url('juris/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('juris/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
