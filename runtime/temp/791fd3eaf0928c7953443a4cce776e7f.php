<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wwwroot\qnysj1\wwwroot/app/index/view/usercontrol/school_user.html";i:1500724364;s:62:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/ModelBase.html";i:1498016174;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
         <li data-type="mine-jie" lay-id="index" class=""><a href="<?php echo url('usercontrol/module_update'); ?>">学校信息</a></li>
		<li data-type="mine-jie" lay-id="index" class="layui-this"><a href="<?php echo url('usercontrol/school_user'); ?>">学校相关</a></li>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
			<?php if(is_array($list_shool_user) || $list_shool_user instanceof \think\Collection || $list_shool_user instanceof \think\Paginator): $i = 0; $__LIST__ = $list_shool_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li >
			  <a href="javascript:void(0);" onclick="del(<?php echo $vo['id']; ?>)"><i class="layui-icon" style="font-size: 25px;">&#x1006;</i></a>
              <a href="<?php echo url('user/index',['user_id'=>$vo['user_id']]); ?>" target="_blank"><?php echo $vo['user_name']; ?></a>
			  <a href="#" target="_blank" ><?php echo $vo['tname']; ?></a>
          ...
          <div id="LAY_page">
			<?php echo $list_shool_user->render(); ?>
		  </div>
        </div>
...
function del(id)
	{
		layer.confirm('删除之后不可恢复，是否继续执行？', {
		  ...
		  btn1:function(index, layero){
				$.ajax({
				url:"<?php echo url('usercontrol/school_user_del'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
