<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/player/index.html";i:1494902012;s:64:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/public/base.html";i:1494994800;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<input type="text" name="title" id="stxt" style="width:360px;float:left;" placeholder="选手姓名" class="layui-input">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['status'] == 0)): ?><a>未审核</a><?php elseif(($vo['back_2'] == 1)): ?><a style="color:#00aa00;">参赛中</a><?php elseif(($vo['back_2'] == 2)): ?><a style="color:red;">已淘汰</a><?php endif; ?></td>
...
<a class="layui-btn" href="/admin/player/print_list.html" style="margin-left: 20px;" target="_blank" >批量打印</a>
