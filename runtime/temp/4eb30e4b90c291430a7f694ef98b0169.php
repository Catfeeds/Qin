<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/school/index2.html";i:1495251100;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		...
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item" href="<?php echo url('school/index'); ?>">校区集锦</a>
				<a class="mui-control-item mui-active" href="<?php echo url('school/index2'); ?>">热点时讯</a>
			</div>
		</div>
		<ul id="ajax_index_return" class="mui-table-view">
			<?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<li class="mui-table-view-cell mui-media">
				<a href="<?php echo url('school/news_info',['news_id'=>$vo['id']]); ?>">
