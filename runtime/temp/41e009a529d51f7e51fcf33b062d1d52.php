<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/school/update.html";i:1498791526;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li onclick="javascript:window.location.href='<?php echo url('school/index'); ?>'">学校列表</li>
    <li class="layui-this">修改学校</li>
  </ul>
</div> 
...
<input type="hidden" name="uid" value="<?php echo $uobj['id']; ?>">
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="aname" lay-filter="aname" required lay-verify="required" placeholder="请输入账号" value="<?php echo $uobj['name']; ?>" autocomplete="off" class="layui-input" >
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
...
layui.use(['form'], function(){
  ...
  form.on('select(pir)', function(data){
		$.ajax({
			url:"<?php echo url('school/getregc'); ?>",
			type:"post",
			dataType:"json",
