<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\wwwroot\qnysj1\wwwroot/app/index/view/school/school_arts.html";i:1499416874;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
...
<!-- 代码 结束 -->
        ...
        <div class="news_more">
        	<div class="news_more_title" style="border-bottom: 1px solid #dddddd;">
				...
				<a href="<?php echo url('school/school_info',['school_id'=>$obj['id']]); ?>" style="color: #5a5858;font-size: 18px;padding-left: 10px;">参赛校友</a>
				<a href="<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>1]); ?>" style="color: #5a5858;font-size: 18px;padding-left: 10px;">校友风采</a>
