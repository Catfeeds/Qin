<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/lists/list_player.html";i:1495101628;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<script type="text/javascript" charset="utf-8">
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('lists/index'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
