<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\articles\index.html";i:1493093195;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
	...
	<li onclick="javascript:window.location.href='<?php echo url('articles/add'); ?>'" >添加时讯</li>
  </ul>
</div> 
<blockquote class="layui-elem-quote layui-quote-nm">
<label class="layui-form-label">搜索：</label>
<form class="layui-form" action="<?php echo url('',['page'=>1]); ?>" method="post" >
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <dl class="layui-btn-group">
		  <a href="<?php echo url('article/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	form.on('switch(yyy)', function(data){
	  ...
	  if(data.elem.checked)
		...
		else
		{
			...
			$.ajax({
				url:"<?php echo url('articles/art_update'); ?>",
				type:"post",
				dataType:"json",
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('articles/art_delete'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
