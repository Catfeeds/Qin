<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\school\school_arts.html";i:1493098231;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493139429;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
 ...
 <style>
	...
	<body>
		...
		<div class="box_lef lef">
			...
			<div class="box_shux">
				<ul class="activity">
					<li onclick="Javascript:location.href='<?php echo url('school/school_info',['school_id'=>$obj['id']]); ?>';">参赛校友</li>
					<li onclick="Javascript:location.href='<?php echo url('school/school_arts',['school_id'=>$obj['id']]); ?>';" class="cli">校区时讯</li>
					<li onclick="Javascript:location.href='<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>1]); ?>';" >校友风采</li>
				</ul>
				<div class="sign_up1">
	...
	<div class="box_rig rig">
		<div class="acti">
			<div class="journalism_tit"><span>LAT</span>ALTEST NEWSLETTER &nbsp;&nbsp;<?php echo $obj['name']; ?></div>
			...
			<div class="journalism_tit">
				<span class="lef">校区时讯</span>
					<?php echo $list_all->render(); ?>
			</div>
			<ul class="bri_int">
				<li>
				<div class="bri_int_lef">
				
				<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($list_all) ? array_slice($list_all,0,3, true) : $list_all->slice(0,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>

					<div class="bri_int_lef_t<?php if($k == '1'): ?>it<?php endif; ?>">
						<a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$vo['id']]); ?>">
							<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a>
					</div>
				
				<?php endforeach; endif; else: echo "" ;endif; ?>
					
					</div>
					<?php if(count($list_all) >= '1'): ?>
					<div class="bri_int_rig"><a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$list_all[0]['id']]); ?>"><img src="<?php echo $list_all[0]['img']; ?>"/></a></div><?php endif; ?>
				</li>

				<li>
				<div class="bri_int_lef">
				
				<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($list_all) ? array_slice($list_all,3,3, true) : $list_all->slice(3,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>

				<div class="bri_int_lef_t<?php if($k == '1'): ?>it<?php endif; ?>">
				<a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$vo['id']]); ?>">
				<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a></div>
				
				<?php endforeach; endif; else: echo "" ;endif; ?>
					
					</div>
					<?php if(count($list_all) >= '4'): ?>
					<div class="bri_int_rig"><a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$list_all[3]['id']]); ?>"><img src="<?php echo $list_all[3]['img']; ?>"/></a></div><?php endif; ?>
				</li>

				<li>
				<div class="bri_int_lef">
				
				<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($list_all) ? array_slice($list_all,6,3, true) : $list_all->slice(6,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
				<div class="bri_int_lef_t<?php if($k == '1'): ?>it<?php endif; ?>">
				<a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$vo['id']]); ?>">
				<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a></div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<?php if(count($list_all) >= '7'): ?>
					<div class="bri_int_rig"><a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$list_all[6]['id']]); ?>"><img src="<?php echo $list_all[6]['img']; ?>"/></a></div><?php endif; ?>
				</li>

				<li>
				<div class="bri_int_lef">
				<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($list_all) ? array_slice($list_all,9,3, true) : $list_all->slice(9,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
				<div class="bri_int_lef_t<?php if($k == '1'): ?>it<?php endif; ?>">
				<a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$vo['id']]); ?>">
				<?php if($k == '1'): ?><?php echo $vo['esc']; else: ?><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo $vo['title']; endif; ?></a></div>
					<?php endforeach; endif; else: echo "" ;endif; if(count($list_all) >= '10'): ?>
					<div class="bri_int_rig"><a class="lef" href="<?php echo url('school/art_info',['school_id'=>$obj['id'],'art_id'=>$list_all[9]['id']]); ?>"><img src="<?php echo $list_all[9]['img']; ?>"/></a></div><?php endif; ?>
				</li>
			</ul>
		</div>
	</div>
