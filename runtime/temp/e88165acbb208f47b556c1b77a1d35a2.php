<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\qnysj1\wwwroot/app/index/view/media/news_info.html";i:1499416926;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $obj['title']; ?>-<?php echo \think\Session::get('gjz.title'); ?></title>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
            	<li><a href="<?php echo url('media/index'); ?>" class="<?php if($obj['tid']==1): ?>dangqian<?php endif; ?>">校园院报</a></li>
                <li><a href="<?php echo url('media/index',['type_id'=>1]); ?>" class="<?php if($obj['tid']==2): ?>dangqian<?php endif; ?>">校园之声</a></li>
            </ul>
        </div>
...
<div id="full-screen-slider03">
		<ul id="slides03">
			...
			<?php if(is_array($list_news_t) || $list_news_t instanceof \think\Collection || $list_news_t instanceof \think\Paginator): $i = 0; $__LIST__ = $list_news_t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li style="background:url(<?php echo $vo['img']; ?>) no-repeat center top;background-size:cover;"><a href="<?php echo url('media/news_info',['news_id'=>$vo['id']]); ?>" target="_blank"><?php echo $vo['id']; ?></a></li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- 代码 结束 -->
        ...
        <?php if(is_array($list_news_t) || $list_news_t instanceof \think\Collection || $list_news_t instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($list_news_t) ? array_slice($list_news_t,1,1, true) : $list_news_t->slice(1,1, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div class="news_headlines"><?php echo $vo['esc']; ?>... <a href="<?php echo url('media/news_info',['news_id'=>$vo['id']]); ?>" target="_blank">[详细]</a></div>		
		<?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="news_headlines_list">
        	<ul>
				<?php if(is_array($list_news) || $list_news instanceof \think\Collection || $list_news instanceof \think\Paginator): $i = 0; $__LIST__ = $list_news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					...
					<li><a href="<?php echo url('media/News_info',['news_id'=>$vo['id']]); ?>" target="_blank"><?php echo date('Y-m-d',$vo['add_time']); ?> &nbsp;&nbsp;<?php echo $vo['title']; ?>... [详细]</a></li>

				<?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="news_detailed">
        	<div class="news_detailed_position"><a href="#">校园媒体</a> &gt; <a href="#"><?php echo $obj['tname']; ?></a></div>
            <div class="news_detailed_title">
			<h2><?php echo $obj['title']; ?></h2>
			文章来源：<?php echo $obj['edit']; ?>&nbsp;&nbsp;&nbsp;
			添加时间：<?php echo date('Y-m-d',$obj['add_time']); ?>&nbsp;&nbsp;&nbsp;
			所属分类：<?php echo $obj['tname']; ?>&nbsp;&nbsp;&nbsp;
			浏览次数：<?php echo $obj['look']; ?>
			</div>
