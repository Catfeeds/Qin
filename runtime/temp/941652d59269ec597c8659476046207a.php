<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\txt\index.html";i:1489982554;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1490161543;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
		...
		<ul class="layui-nav layui-nav-tree">
		  ...
		  <li class="layui-nav-item">
			...
			<dl class="layui-nav-child">
			  ...
			  <dd><a href="<?php echo url('user/index'); ?>"><i class="layui-icon">&#xe602;</i>动态列表</a></dd>
			</dl>
		  </li>
		  <li class="layui-nav-item">
...
<input type="file" name="txt" class="layui-upload-file">
</blockquote>
