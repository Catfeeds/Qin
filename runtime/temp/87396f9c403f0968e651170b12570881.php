<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/news/index.html";i:1493800574;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		...
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item mui-active" href="<?php echo url('News/index'); ?>">赛事时讯</a>
				<a class="mui-control-item" href="<?php echo url('News/index2'); ?>">活动公告</a>
			</div>
		</div>
