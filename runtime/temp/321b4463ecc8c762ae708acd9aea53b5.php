<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wwwroot\qnysj1\wwwroot/app/index/view/player/index_type.html";i:1508639100;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>大赛报名-<?php echo \think\Session::get('gjz.title'); ?></title>
...
<script type="text/javascript">
      ...
      <ul class="fly-case-list">
		...
		<?php if(is_array($tlist) || $tlist instanceof \think\Collection || $tlist instanceof \think\Paginator): $i = 0; $__LIST__ = $tlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			...
			<li data-id="<?php echo $vo['id']; ?>">
			  ...
			  <h2>
				<a href="/index/player/index/type_id/<?php echo $vo['id']; ?>.html" style="font-size:25px;" target="_blank"><?php echo $vo['name']; ?></a>
			  </h2>
	...
	<div style="text-align: center;">
			...
			<div style="font-size: 20px;font-weight: 600;">温馨提示</div>
			 <div> 
			  
			  动漫创意大赛与文学、书法、绘画、摄影大赛报名截止时间为：9月30号。<br/>
			  微电影大赛报名截止时间为：10月20日。<br/>
			  才艺大赛与朗诵大赛报名截止时间为：10月21日。<br/>
