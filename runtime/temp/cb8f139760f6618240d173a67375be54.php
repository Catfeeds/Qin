<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/index/user_art_rep.html";i:1500764316;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<link rel="stylesheet" type="text/css" href="__STATIC__/layui/css/layui.css" />
	...
	<div class="mui-content">
		<div class="mui-content-padded">
			<div class="mui-inline">举报动态</div>
		</div>
		<div class="row mui-input-row">
			<textarea id="content" name="content" placeholder="举报原因..."></textarea>
...
layui.use(['form','layedit'], function(){
  ...
  form.on('submit(sbt)', function(data){
	...
	$.ajax({
		url:"<?php echo url('index/art_rep_add'); ?>",
		type:"post",
		dataType:"json",
		data:{'art_id':$('#art_id').val(),'content':tt},
		success:function(dd){
