<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\user\img_list.html";i:1492494263;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492584676;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="<?php echo $vo['img']; ?>" style="width:200px;" /></td>
	...
	form.on('switch(yyy)', function(data){
	  ...
	  if(data.elem.checked)
		...
		else
		{
			...
			$.ajax({
				url:"<?php echo url('user/img_update'); ?>",
				type:"post",
				dataType:"json",
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('user/img_delete'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
