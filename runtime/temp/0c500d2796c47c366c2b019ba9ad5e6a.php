<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/user/record.html";i:1501228668;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item mui-active" href="<?php echo url('user/record'); ?>">来访记录</a>
...
<script type="text/javascript" charset="utf-8">
		...
		$('#ajax_record_return').on('tap', '.mui-btn', function(event) {
			...
			mui.confirm('确认删除该条记录？', '通知信息', btnArray, function(e) {
				if (e.index == 0) {
					...
					mui.ajax('<?php echo url('User/record_del'); ?>',{
						data:{id:id},
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('user/record'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
