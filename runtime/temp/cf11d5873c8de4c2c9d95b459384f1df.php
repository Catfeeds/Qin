<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/index/view/school/school_info.html";i:1497428548;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
            ...
            <div class="player_more_list">
            	<ul>
					<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $i = 0; $__LIST__ = $list_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <dt><a href="#"><?php echo $vo['look']; ?></a></dt>
                        <dd style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;width: 95px;"><?php echo $vo['user_name']; ?></dd>
                        <dl></dl>
						</li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
