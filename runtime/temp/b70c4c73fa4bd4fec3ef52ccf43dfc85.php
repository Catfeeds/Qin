<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wwwroot\qnysj1\wwwroot/app/index/view/news/news_info.html";i:1499416852;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
            	<li><a href="<?php echo url('news/index',['type_id'=>1]); ?>" class="<?php if($obj['maxtype_id'] == 1): ?>dangqian<?php endif; ?>">赛事时讯</a></li>
                <li><a href="<?php echo url('news/index',['type_id'=>2]); ?>" class="<?php if($obj['maxtype_id'] == 2): ?>dangqian<?php endif; ?>">活动公告</a></li>
            </ul>
        </div>
...
<!-- 代码 结束 -->
        ...
        <div class="news_detailed">
        	<div class="news_detailed_position"><a href="#">新闻资讯</a> &gt; <a href="#"><?php echo $obj['maxtype_name']; ?></a></div>
            <div class="news_detailed_title">
			<h2><?php echo $obj['title']; ?></h2>
			文章来源：<?php echo $obj['edit']; ?>&nbsp;&nbsp;&nbsp;
			添加时间：<?php echo date('Y-m-d',$obj['add_time']); ?>&nbsp;&nbsp;&nbsp;
			所属分类：<?php echo $obj['maxtype_name']; ?>&nbsp;&nbsp;&nbsp;
