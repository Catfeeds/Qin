<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/user/player.html";i:1505627892;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
	    ...
	    <form id='fid' class="mui-input-group" action="" method="post" enctype="multipart/form-data">
			...
			<div class="mui-input-row">
				<label>所属状态</label>
				<input id='tp_name' name="tp_name" type="text" value="<?php if(($obj['sid'] != 0&&$obj['back_4']==1)): ?>在校<?php else: ?>社会<?php endif; ?>" placeholder="所属状态" class="mui-input" readonly>
			...
			<div class="mui-input-row" id="sss" <?php if($obj['ssid']==0): ?>style="display:none;"<?php endif; ?>>
				<label>所属单位</label>
				<input id='ssname' name="ssname" type="text" value="<?php echo $obj['ssname']; ?>" placeholder="所属单位" class="mui-input" readonly>
				<input type="hidden" name="ssid" id="ssid" value="<?php echo $obj['ssid']; ?>">
			</div>
			...
			<div class="mui-input-row" id="xx_id" <?php if(($obj['back_4']==0&&$obj['ssid']!=0)): ?>style="display:none;"<?php else: ?>style="display:block;"<?php endif; ?>>
				<label>所属详细</label>
				<input id='unit' name="unit" value="<?php echo $obj['unit']; ?>" type="text" class="mui-input-clear mui-input" placeholder="<?php if(($obj['back_4']==1)): ?>请输入所属学校的院,系,级信息<?php else: ?>请输入所属单位名称<?php endif; ?>">
			</div>
			<div class="mui-input-row">
				<label>通讯地址</label>
    ...
    <script type="text/javascript" charset="utf-8">
		...
		pickerss.setData(<?php echo $sslist; ?>);
