<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/lists/list_school.html";i:1500606826;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item" href="<?php echo url('lists/list_player'); ?>">选手排名</a>
				<a class="mui-control-item mui-active" href="<?php echo url('lists/list_school'); ?>">校区排名</a>
		...
		<?php if(!(empty($list_user_school) || (($list_user_school instanceof \think\Collection || $list_user_school instanceof \think\Paginator ) && $list_user_school->isEmpty()))): ?>
...
<script type="text/javascript" charset="utf-8">
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('lists/list_school'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
