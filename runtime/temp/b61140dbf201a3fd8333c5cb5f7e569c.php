<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\school\index.html";i:1493130901;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493139429;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="box_lef lef">
			...
			<div class="box_shux">
				<ul class="activity">
					<li class="cli" onclick="Javascript:location.href='<?php echo url('school/index'); ?>';">醉美校园</li>
					<li onclick="Javascript:location.href='<?php echo url('school/index_news'); ?>';">校区时讯</li>
				...
				<div class="box_rig rig">
					<div class="acti">
						<div class="journalism_tit"><span>DRU</span>NK BEAUTY CAMPUS <span>醉美校园</span></div>
						<div class="new_banner">
						<img src="<?php if(count($list_school) >= '1'): ?><?php echo $list_school[0]['img']; else: ?>__index__/img/020.png<?php endif; ?>"/></div>
						<ul class="sch_pre">
							<?php if(is_array($list_school) || $list_school instanceof \think\Collection || $list_school instanceof \think\Paginator): $i = 0; $__LIST__ = $list_school;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<li onclick="Javascript:location.href='<?php echo url('school/school_info',['school_id'=>$vo['id']]); ?>"><img src="<?php echo $vo['img']; ?>"/></li>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
...
<script type="text/javascript">
	$(function(){
		$(".sch_pre li").mouseover(function(){
			$(".new_banner img").attr("src",$(this).find("img").attr("src"));
			console.log(123321)
			$(".eve_reg li").eq($(this).index()).show().siblings().hide();
		})
