<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\news\add.html";i:1493273758;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="" method="post" id="fid" enctype="multipart/form-data">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="edit" lay-filter="edit" value="<?php echo \think\Session::get('admin_auth.nickname'); ?>" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
