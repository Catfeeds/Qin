<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/user/guestbook.html";i:1501228710;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				...
				<a class="mui-control-item mui-active" href="<?php echo url('user/guestbook'); ?>">留言</a>
		...
		$('#ajax_guestbook_return').on('tap', '.mui-btn', function(event) {
			...
			mui.confirm('确认删除该条记录？', '通知信息', btnArray, function(e) {
				if (e.index == 0) {
					...
					mui.ajax('<?php echo url('User/guestbook_del'); ?>',{
						data:{id:id},
