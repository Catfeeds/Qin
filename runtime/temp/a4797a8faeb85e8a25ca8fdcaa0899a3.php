<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/player/update.html";i:1495788402;s:58:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/public/base.html";i:1496904694;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <tbody>
	...
	<tr style="display:<?php if(($pobj['status'] == 1)): ?>table-row<?php else: ?>none<?php endif; ?>;">
      ...
      <td colspan="7"> 
		...
		<input type="radio" name="cc" value="3" title="复赛" <?php if(($pobj['back_2'] == 3)): ?>checked<?php endif; ?>>
		<input type="radio" name="cc" value="4" title="决赛" <?php if(($pobj['back_2'] == 4)): ?>checked<?php endif; ?>>
		<input type="radio" name="cc" value="5" title="省决赛" <?php if(($pobj['back_2'] == 5)): ?>checked<?php endif; ?>>
