<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\user\index.html";i:1491809932;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('user/insert'); ?>'">添加用户</li>
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['last_time'] != null)): ?><?php echo date("y-m-d h:s",$vo['last_time']); endif; ?></td>
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('user/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
			  <a href="<?php echo url('user/art_list',['id'=>$vo['id']]); ?>" class="layui-btn">动态</a>
			  <a href="<?php echo url('user/img_list',['id'=>$vo['id']]); ?>" class="layui-btn">相册</a>
			  <a href="<?php echo url('user/gb_list',['id'=>$vo['id']]); ?>" class="layui-btn">留言</a>
			  <a href="<?php echo url('user/ri_list',['id'=>$vo['id']]); ?>" class="layui-btn">日志</a>
