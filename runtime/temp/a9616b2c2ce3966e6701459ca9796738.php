<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wwwroot\qnysj1\wwwroot/app/index/view/usercontrol/school_player.html";i:1505896440;s:62:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/ModelBase.html";i:1498016174;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
		<li data-type="mine-jie" lay-id="index"><a href="<?php echo url('usercontrol/index_player_school'); ?>">本校报名信息</a></li>
          ...
          <form class="layui-form layui-form-pane"  style="padding: 20px 0;" action="" method="post" id="fid" enctype="multipart/form-data">
			<div class="layui-form-item">
			  ...
			  <div class="layui-form-item" pane style="display:<?php if(($obj['status'] == 1)): ?>block<?php else: ?>none<?php endif; ?>;">
				...
				<div class="layui-input-block">
				    <input type="radio" name="cc" value="1" title="已审核" <?php if(($obj['back_2'] == 1)): ?>checked<?php elseif(($obj['back_2'] != 2)): ?>checked<?php endif; ?>>
