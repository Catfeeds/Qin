<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\news\update.html";i:1493273975;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<input type="hidden" name="aid" value="<?php echo $nobj['id']; ?>">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="edit" lay-filter="edit" value="<?php echo $nobj['edit']; ?>" autocomplete="off" class="layui-input" readonly>
    </div>
  </div>
   <div class="layui-form-item" style="width:600px">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <textarea name="esc" placeholder="请输入简介"  value="<?php echo $nobj['esc']; ?>" class="layui-textarea"><?php echo $nobj['esc']; ?></textarea>
    </div>
  </div>
