<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\user\update.html";i:1492741936;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	...
	<div class="layui-input-inline" id="cid" >
	 ...
	 <div class="layui-input-inline" id="sid" style="display:<?php if(($uobj['type'] == 1)): ?>block<?php else: ?>none<?php endif; ?>;">
      <select name="sid" style="width:200px;">
		 <option value="" >请选择</option>
		 <?php if(($uobj['type'] == 1)): if(is_array($slist) || $slist instanceof \think\Collection || $slist instanceof \think\Paginator): $i = 0; $__LIST__ = $slist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sj): $mod = ($i % 2 );++$i;?>
