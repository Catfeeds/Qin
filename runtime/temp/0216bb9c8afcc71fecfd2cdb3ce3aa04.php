<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\wwwroot\qnysj1\wwwroot/app/index/view/user/art_info.html";i:1502688410;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
        ...
        <div class="homepage_comment" id="pg">
			...
			<div class="comment_list">
                <div class="comment_list_right" style="float: none;width: 100%;">
					<?php if($aobj['back_3']==1): ?>
                	<img style="position: absolute;width: 120px;margin-left: -20px;margin-top: -20px;" src="/public/wap/images/jinghua.png" />
					<?php endif; ?>
                    <dl class="detail-body"><?php echo $aobj['content']; ?></dl>
					<dt style="margin-top: 10px;">
					<?php if($aobj['back_1']==2): ?><span style="float: none;font-size:18px;"><a href="<?php echo $aobj['back_2']; ?>" target="_blank">原文链接</a></span><?php endif; ?>
					</dt>
					<dt style="margin-top: 10px;">
					<span style="float: none;font-size:18px;"><?php echo date('Y-m-d H:i',$aobj['add_time']); ?></span>
					<?php if($aobj['user_id']==\think\Session::get('user_auth.id')): ?>
					<a style="float: right;" onclick="art_del(<?php echo $aobj['id']; ?>)">删除</a>
					<?php else: ?>
					<dd id="jieda">
						<a href="javascript:;" style="padding-left: 10px;" onclick="art_rep(<?php echo $aobj['id']; ?>)">举报</a>
					</dd>
					<?php endif; ?>
					</dt>
        	...
        	<div class="comment_list">
                ...
                <div class="comment_list_right">
					...
					<dd id="rr" style="visibility:hidden">
						<a href="javascript:;" style="padding-left: 10px;" onclick="com_rep(<?php echo $vo['id']; ?>)">举报</a>
						<a href="javascript:;" style="padding-left: 10px;" onclick="hf(<?php echo $vo['id']; ?>,<?php echo $vo['user_id']; ?>,'<?php echo $vo['user_name']; ?>')">回复</a>
						<?php if($vo['user_id']==\think\Session::get('user_auth.id')): ?>
						<a href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)">删除</a>
						<?php elseif($obj['user_id']==\think\Session::get('user_auth.id')): ?>
						<a href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)">删除</a>
						<?php endif; ?>		
            ...
            <div class="comment_message">
				...
				<form action="" method="post" id="plhf" class="layui-form">
					<div class="comment_message_02" style="background-color: #fff;">
						...
						<input type="hidden" id="art_id" name="art_id" value="<?php echo $aobj['id']; ?>">
						<input type="hidden" id="art_title" name="art_title" value="动态">
						<input type="hidden" id="type" name="type" value="2">
						<input type="hidden" id="pid" name="pid" value="<?php echo $aobj['id']; ?>">
						<input type="hidden" id="puid" name="puid" value="<?php echo $aobj['user_id']; ?>">
					</div>
...
<script type="text/javascript" src="/public/index/js/user_art_js.js"></script>
<script>
