<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\broadcast\index.html";i:1491878525;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492353720;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('broadcast/insert'); ?>'">添加直播</li>
  </ul>
</div> 
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><a target="_blank" href="<?php echo $vo['url']; ?>"></a><?php echo $vo['url']; ?></td>
	  <td><?php if(($vo['status'] == 1)): ?><a>显示</a><?php else: ?><a>隐藏</a><?php endif; ?></td>
      ...
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('broadcast/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('broadcast/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
