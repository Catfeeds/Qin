<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\wwwroot\qnysj1\wwwroot/app/index/view/usercontrol/index_player_community.html";i:1498100120;s:62:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/ModelBase.html";i:1498016174;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">本区报名信息（<span><?php echo count($plist); ?></span>）</li>
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
            ...
            <li >
			  ...
			  <a href="<?php echo url('usercontrol/community_player',['player_id'=>$vo['id']]); ?>" target="_blank" >
