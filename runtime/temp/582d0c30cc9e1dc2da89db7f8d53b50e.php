<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/index/view/lists/index_player.html";i:1495352532;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>热门选手排行-<?php echo cookie('remark')['title']; ?></title>
            ...
            <div class="player_more_list">
            	<ul>
					<?php if(is_array($list_player) || $list_player instanceof \think\Collection || $list_player instanceof \think\Paginator): $i = 0; $__LIST__ = $list_player;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <dt><a href="<?php echo url('user/index',['user_id'=>$vo['id']]); ?>"><?php echo $vo['back_3']; ?></a></dt>
