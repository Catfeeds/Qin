<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/index.html";i:1497164726;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1497237796;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">来访纪录（<span><?php echo count($list_record); ?></span>）</li>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
            ...
            <li >
			  <?php if(($vo['look'] == 0)): ?>
			  <a href="javascript:void(0);" onclick="update(<?php echo $vo['id']; ?>)"><i class="layui-icon" style="color: #00EE00;font-size: 25px;">&#xe623;</i></a>
			  <?php else: ?>
			  ...
			  <a href="<?php echo url('usercontrol/record_look',['rid'=>$vo['id']]); ?>" target="_blank" ><?php echo $vo['content']; ?></a>
...
function del(id)
	{
		layer.confirm('删除之后不可恢复，是否继续执行？', {
		  ...
		  btn1:function(index, layero){
				$.ajax({
				url:"<?php echo url('usercontrol/record_del'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
...
function update(id)
	{
		$.ajax({
				url:"<?php echo url('usercontrol/record_update'); ?>",
				type:"post",
				dataType:"json",
				data:{aid:id},
				success:function(dd){
