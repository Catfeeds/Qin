<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\works\index.html";i:1492508868;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492584676;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php if(($vo['status'] == 1)): ?><a>已审核</a><?php else: ?><a>未审核</a><?php endif; ?></td>
	  <td><?php echo date("y-m-d h:s",$vo['add_time']); ?></td>
      <td >
	  <dl class="layui-btn-group">
		  <a href="<?php echo url('works/w_info',['id'=>$vo['id']]); ?>" class="layui-btn">详细</a>
		  <!--<a href="<?php echo url('works/vote',['id'=>$vo['id']]); ?>" class="layui-btn">投票记录</a>-->
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('works/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
