<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\types\index.html";i:1491626926;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('types/insert'); ?>'">添加分类</li>
  </ul>
</div> 
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
      <th><?php echo $i; ?></th>
      <td>
	  <?php echo !empty($vo['back_1']) && $vo['back_1']=="2"?"|----":""; ?>
	  <?php echo !empty($vo['back_1']) && $vo['back_1']=="3"?"-----|----":""; ?>
	  <?php echo $vo['name']; ?></td>
      <td>
	  <?php if(($vo['back_1'] == 1)): ?>一级分类<?php elseif(($vo['back_1'] == 2)): ?>二级分类<?php elseif(($vo['back_1'] == 3)): ?>三级分类<?php endif; ?>
	  </td>
      ...
      <td >
		<dl class="layui-btn-group">
		  <a href="<?php echo url('types/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('types/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
