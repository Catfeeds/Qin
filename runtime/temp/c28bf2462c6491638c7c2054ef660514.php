<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/index/view/school/school_arts.html";i:1497173156;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
...
<!-- 代码 结束 -->
        ...
        <div class="news_more">
        	<div class="news_more_title" style="border-bottom: 1px solid #dddddd;">
				...
				<a href="<?php echo url('school/school_arts',['school_id'=>$obj['id'],'type'=>1]); ?>" style="color: #e32024;font-size: 18px;">校区时讯</a>
				<a href="<?php echo url('school/school_info',['school_id'=>$obj['id']]); ?>" style="color: #c0bcbc;font-size: 18px;">参赛校友</a>
				<a href="<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>1]); ?>" style="color: #c0bcbc;font-size: 18px;">校友风采</a>
