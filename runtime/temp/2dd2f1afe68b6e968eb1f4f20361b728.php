<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\index\index.html";i:1493875017;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1493874118;}*/ ?>
		...
		<div id="full-screen-slider">
			<ul id="slides">
				<?php if(is_array($list_activity) || $list_activity instanceof \think\Collection || $list_activity instanceof \think\Paginator): $i = 0; $__LIST__ = $list_activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$io): $mod = ($i % 2 );++$i;?>
					<li style="background:url('<?php echo $io['img']; ?>') no-repeat center top"><a href="<?php echo url('activity/activity_info',['act_id'=>$io['id']]); ?>" target="_blank"><?php echo $io['id']; ?></a></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	<!-- 代码 结束 -->
