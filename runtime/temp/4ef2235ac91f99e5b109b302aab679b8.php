<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/index/guestbook.html";i:1502694294;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="wrap">
	<header id="header">
		...
		<div class="nvtt">
			<span style="font-size: 15px;">留言</span>
		</div>
	</header>
	...
	<div id="content" class="content">
		<div class="texts">
			<span style="font-size: 15px; vertical-align: bottom; color: #8f8f94;">给TA留言</span>
		</div>
		<div class="trend">
			<textarea id="demo" name="demo">留言内容...</textarea>
...
layui.use(['form','layedit'], function(){
  ...
  form.on('submit(sbt)', function(data){
	...
	$.ajax({
		url:"<?php echo url('index/user_art_gb'); ?>",
		type:"post",
		dataType:"json",
		data:{'uid':$('#uid').val(),'content':tt},
		success:function(dd){
			layer.msg(dd.msg, function(){
				location.href="/wap/index/user_gb_list/user_id/<?php echo $userid; ?>.html";
			});
		}
	})
