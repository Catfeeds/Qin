<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\usercontrol\module_add.html";i:1493186002;s:67:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\ModelBase.html";i:1493095052;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">社团信息</li>
      </ul>
          ...
          <form class="layui-form layui-form-pane"  style="padding: 20px 0;" action="" method="post" id="fid" enctype="multipart/form-data">
			  <div class="layui-form-item">
				...
				<div class="layui-input-block">
				  <input type="text" name="name" placeholder="请输入名称"   required lay-verify="required" value="<?php if($obj!=0): ?><?php echo $obj['name']; endif; ?>" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item" pane>
				...
				<div class="layui-input-block" id="id_img">
					<img style="width:200px" src="<?php if($obj!=0): ?><?php echo $obj['img']; else: ?>__IMG__/timg.jpg<?php endif; ?>"/>
				</div>
			  </div>
			  <div class="layui-form-item">
				...
				<div class="layui-input-inline" id="tid">
				  <select name="tid" required lay-verify="required" lay-filter="pir" style="width:200px;">
					 ...
					 <?php if(is_array($slist) || $slist instanceof \think\Collection || $slist instanceof \think\Paginator): $i = 0; $__LIST__ = $slist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sj): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $sj['id']; ?>"><?php echo $sj['name']; ?></option>
			  ...
			  <div class="layui-form-item" pane>
				<label class="layui-form-label">申请人照片</label>
				<div class="layui-input-block">
...
layui.use('form', function(){
  ...
  form.on('submit(formDemo)', function(data){
	  ...
	  $.ajax({
		...
		type:"post",
		dataType:"json",
		data:{aname:data.field['name'],aid:aa},
		success:function(dd){
			if(dd.e>0)
			{
				layer.msg("该名称社团已存在");
