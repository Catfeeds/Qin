<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\wwwroot\wchhui1\wwwroot/app/index/view/news/index.html";i:1497429060;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>新闻资讯-<?php echo cookie('remark')['title']; ?></title>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
            	<li><a href="<?php echo url('news/index',['type_id'=>1]); ?>" class="<?php if($t_id==1): ?>dangqian<?php endif; ?>">赛事时讯</a></li>
                <li><a href="<?php echo url('news/index',['type_id'=>2]); ?>" class="<?php if($t_id==2): ?>dangqian<?php endif; ?>">活动公告</a></li>
            </ul>
        </div>
...
<!-- 代码 结束 -->
		...
		<?php if(is_array($list_news_t) || $list_news_t instanceof \think\Collection || $list_news_t instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($list_news_t) ? array_slice($list_news_t,1,1, true) : $list_news_t->slice(1,1, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div class="news_headlines"><?php echo $vo['esc']; ?>... <a href="<?php echo url('news/news_info',['news_id'=>$vo['id']]); ?>" target="_blank">[详细]</a></div>		
		<?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="news_headlines_list" id="pg">
        	<ul>
				<?php if(is_array($list_news) || $list_news instanceof \think\Collection || $list_news instanceof \think\Paginator): $i = 0; $__LIST__ = $list_news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					...
					<li><a href="<?php echo url('news/News_info',['news_id'=>$vo['id']]); ?>" target="_blank"><?php echo date('Y-m-d',$vo['add_time']); ?> &nbsp;&nbsp;<?php echo $vo['title']; ?>... [详细]</a></li>
        ...
        <div class="news_more">
        	<div class="news_more_title" style="border-bottom: 1px solid #dddddd;">
            	<?php echo $list_all->render(); if($t_id==1): ?>
					<a href="<?php echo url('news/index',['type_id'=>1]); ?>" style="color: #e32024;font-size: 18px;">赛事时讯</a>
					<a href="<?php echo url('news/index',['type_id'=>2]); ?>" style="color: #5a5858;font-size: 18px;padding-left: 10px;">活动公告</a>
				<?php else: ?>
					<a href="<?php echo url('news/index',['type_id'=>2]); ?>" style="color: #e32024;font-size: 18px;">活动公告</a>
					<a href="<?php echo url('news/index',['type_id'=>1]); ?>" style="color: #5a5858;font-size: 18px;padding-left: 10px;">赛事时讯</a>
			...
			<?php if(is_array($list_all) || $list_all instanceof \think\Collection || $list_all instanceof \think\Paginator): $i = 0; $__LIST__ = $list_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($i==1||$i==4||$i==7||$i==10): ?>
				<div class="news_more_list">
					<div class="news_more_list_left">
						<div class="news_more_list_left_01"><?php echo $vo['esc']; ?>... <a href="<?php echo url('news/news_info',['news_id'=>$vo['id']]); ?>" target="_blank">[详细]</a></div>
