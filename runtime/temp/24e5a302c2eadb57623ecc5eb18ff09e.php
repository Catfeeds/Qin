<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/index/index.html";i:1497249806;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<style>
	...
	<div class="mui-content">
		<!--静态图片-->
		    ...
		    <ul class="mui-table-view mui-grid-view">
		        ...
		        <li class="mui-table-view-cell mui-media mui-col-xs-6">
		            <a href="<?php echo url('school/school_info',['school_id'=>$vo['id']]); ?>">
						...
						<img class="mui-media-object" style="height: 100%;" src="<?php echo $vo['img']; ?>">
						</div>
		    ...
		    <div class="title">校园媒体</div>
			<ul class="mui-table-view">
				<?php if(is_array($list_activity) || $list_activity instanceof \think\Collection || $list_activity instanceof \think\Paginator): $i = 0; $__LIST__ = $list_activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			    <li class="mui-table-view-cell mui-media">
			        <a href="<?php echo url('Media/news_info',['news_id'=>$vo['id']]); ?>">
			            <img class="mui-media-object mui-pull-left" src="<?php echo $vo['img']; ?>">
			            <div class="mui-media-body">
			                <?php echo $vo['title']; ?>
							<p class='mui-ellipsis'><?php echo $vo['esc']; ?></p>
			            </div>
