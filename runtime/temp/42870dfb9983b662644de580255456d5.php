<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/school/index.html";i:1492494964;s:64:"D:\wwwroot\wchhui1\wwwroot/app/guany_admin/view/public/base.html";i:1494998636;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('school/insert'); ?>'">添加学校</li>
  </ul>
</div> 
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td style="color:#00aa00;"><?php if($vo['back_1']==1): ?>分类推荐<?php endif; ?></td>
	  <td><?php echo date("y-m-d h:s",$vo['add_time']); ?></td>
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('school/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
			  <!--<a href="<?php echo url('school/art_list',['id'=>$vo['id']]); ?>" class="layui-btn">动态</a>-->
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('school/deletes'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
