<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/activity/update.html";i:1498790648;s:57:"D:\wwwroot\qnysj1\wwwroot/app/admin/view/public/base.html";i:1500630732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    <li onclick="javascript:window.location.href='<?php echo url('activity/index'); ?>'">资讯列表</li>
...
<form class="layui-form" action="" method="post" id="fid" enctype="multipart/form-data">
  ...
  <div class="layui-form-item" style="width:800px">
    ...
    <div class="layui-input-inline" id="tid">
      <select name="tid" required lay-verify="required" lay-filter="pir" style="width:200px;">
		 ...
		 <option value="1" <?php if(($uobj['tid'] == 1)): ?>selected<?php endif; ?>>校园之声</option>
		 <option value="2" <?php if(($uobj['tid'] == 2)): ?>selected<?php endif; ?>>校园院报</option>
      </select>
    </div>
  </div>
  <div class="layui-form-item" style="width:800px">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <textarea name="keywords" placeholder="请输入关键字" class="layui-textarea"><?php echo $uobj['keywords']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">页面描述</label>
    <div class="layui-input-block">
      <textarea name="description" placeholder="请输入描述" class="layui-textarea"><?php echo $uobj['description']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">资讯简介</label>
    <div class="layui-input-block">
      <textarea name="esc" placeholder="请输入简介" class="layui-textarea"><?php echo $uobj['esc']; ?></textarea>
    </div>
  </div>
   <div class="layui-form-item" style="width:800px">
    <label class="layui-form-label">资讯内容</label>
    <div class="layui-input-block">
      <textarea name="content" id="contt"><?php echo $uobj['content']; ?></textarea>
    </div>
  </div>
...
UE.getEditor('contt',{initialFrameWidth:800,initialFrameHeight:400,});
