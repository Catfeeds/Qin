<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\login\update.html";i:1490593484;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492571125;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-side">
		<ul class="layui-nav layui-nav-tree">
		  ...
		  <li class="layui-nav-item">
			...
			<dl class="layui-nav-child">
			<dd><a href="<?php echo url('login/remark'); ?>"><i class="layui-icon">&#xe602;</i>网站信息</a></dd>
			</dl>
		  </li>
		</ul>
...
<form class="layui-form" id="fid" action="" method="post">
  ...
  <div class="layui-form-item" style="width:600px;display:none;">
    ...
    <div class="layui-input-block">
      <input type="text" name="nickname" required value="<?php echo $aobj['nickname']; ?>"  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input" readonly>
    </div>
  </div>
   <div class="layui-form-item" style="width:600px">
