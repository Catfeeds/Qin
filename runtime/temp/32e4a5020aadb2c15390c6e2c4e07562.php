<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/user/editpwd.html";i:1494318550;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
document.getElementById("editpwd").addEventListener("click", function(){
	...
	if(check){
		...
		//ajax交互，进行找回
		mui.post('<?php echo url('user/editpwd'); ?>',{
