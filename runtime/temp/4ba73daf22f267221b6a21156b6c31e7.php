<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/lists/index.html";i:1495352538;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1497236850;}*/ ?>
        ...
        <div class="school_more">
            ...
            <div class="school_more_list">
            	<ul>
                	...
                	<li>
                    	<a href="<?php echo url('school/school_info',['school_id'=>$vo['sid']]); ?>"  target="_blank"><img src="<?php echo $vo['img']; ?>" width="296" height="150" /></a>
                    </li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
               	</ul>
            </div>
