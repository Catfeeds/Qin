<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/school/school_info.html";i:1497747738;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<style>
	...
	<div class="mui-content">
		<div class="mui-card">
			<div class="mui-card-header mui-card-media" style="height:40vw;padding:0px;"><img src="<?php echo $obj['img']; ?>"  style="width: 100%;height:40vw;"/></div>
			<div class="mui-card-content">
				<div class="mui-card-content-inner">
					<p><?php echo $obj['name']; ?></p>
					<p id="esc_1" style="color: #333;display:block;"><?php echo mb_substr($obj['esc'], 0, 50, 'utf8'); ?>...</p>
					<p id="esc_2" style="color: #333;display:none;"><?php echo $obj['esc']; ?></p>
		...
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item <?php if($type==0): ?>mui-active<?php endif; ?>" href="<?php echo url('school/school_info',['school_id'=>$obj['id']]); ?>">校友风采</a>
				<a class="mui-control-item <?php if($type==1): ?>mui-active<?php endif; ?>" href="<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>1]); ?>">参赛校友</a>
				<a class="mui-control-item <?php if($type==2): ?>mui-active<?php endif; ?>" href="<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>2]); ?>">校区时讯</a>
			</div>
		</div>
		...
		<?php endif; if(!(empty($list_all) || (($list_all instanceof \think\Collection || $list_all instanceof \think\Paginator ) && $list_all->isEmpty()))): ?>
...
<script type="text/javascript" charset="utf-8">
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			...
			page += 1;
			mui.ajax('<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>$type]); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
