<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\live\index.html";i:1492857044;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\Base.html";i:1492888984;}*/ ?>
﻿<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="box_shux">
			<ul class="activity">
				<li class="cli" onclick="Javascript:location.href='<?php echo url('live/index'); ?>';">赛事直播</li>
				<li onclick="Javascript:location.href='<?php echo url('live/index_user'); ?>';">选手直播</li>
	...
	<div class="box_rig rig">
		<div class="acti">
			...
			<div class="eve_reg"><!--预留字段--></div>
			<div class="journalism_tit">
				<span class="lef">赛事直播</span>
			...
			<ul class="bri_int">
				<?php if(is_array($list_bd) || $list_bd instanceof \think\Collection || $list_bd instanceof \think\Paginator): $i = 0; $__LIST__ = $list_bd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li onclick="Javascript:location.href='<?php echo $vo['url']; ?>';"><img src="<?php echo $vo['img']; ?>"/></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
