<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\region\add.html";i:1490504009;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1491797055;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="" id="fid" method="post">
  ...
  <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <input type="text" name="bname" lay-filter="bname" required lay-verify="required" placeholder="请输入编码" autocomplete="off" class="layui-input">
    </div>
  </div>
