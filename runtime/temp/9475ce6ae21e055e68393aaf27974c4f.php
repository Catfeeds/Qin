<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wwwroot\wchhui1\wwwroot/app/index/view/school/art_info.html";i:1495352428;s:58:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/Base.html";i:1496372972;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $obj['name']; ?>-<?php echo cookie('remark')['title']; ?></title>
...
<div class="class_content">
	<div class="class_contnet_left">
    	<div class="class_nav">
        	<ul>
            	<li><a href="<?php echo url('school/school_info',['school_id'=>$obj['id']]); ?>" >参赛选手</a></li>
                <li><a href="<?php echo url('school/school_info',['school_id'=>$obj['id'],'type'=>1]); ?>" >校友风采</a></li>
				<li><a href="<?php echo url('school/school_arts',['school_id'=>$obj['id'],'type'=>1]); ?>" class="dangqian">校区时讯</a></li>
            </ul>
        </div>
...
<!-- 代码 结束 -->
        ...
        <div class="news_school_list">
        	<ul>
				...
				<li>
					<a href="<?php echo url('school/news_info',['news_id'=>$vo['id'],'school_id'=>$obj['id']]); ?>" target="_blank"><?php echo date('Y-m-d',$vo['add_time']); ?>&nbsp;&nbsp;<?php echo mb_substr($vo['title'],0,20,'utf-8'); ?>
						... 
						[详细]</a></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="news_detailed">
        	<div class="news_detailed_position"><a href="#">校区时讯</a> &gt; <a href="#"><?php echo $aobj['tname']; ?></a></div>
            <div class="news_detailed_title">
			<h2><?php echo $aobj['title']; ?></h2>
			文章来源：<?php echo $aobj['edit']; ?>&nbsp;&nbsp;&nbsp;
			添加时间：<?php echo date('Y-m-d',$aobj['add_time']); ?>&nbsp;&nbsp;&nbsp;
			所属分类：<?php echo $aobj['tname']; ?>
			</div>
            <div class="news_detailed_content">
            	<?php echo $aobj['content']; ?>
            </div>
        </div>
