<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/index/user_photo_list.html";i:1500771690;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
<footer class="qui-footerBasic">
	  <ul id="ajax_gb_return" class="layer-photos-demo">
		...
		<img  layer-src="<?php echo $vo['img']; ?>" layer-pid="<?php echo $vo['id']; ?>" src="<?php echo $vo['img']; ?>">
...
mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
	page += 1;
	mui.ajax('<?php echo url('index/user_photo_list'); ?>',{
		data:{
			user_id:id,
			is_ajax:1,
			page:page
