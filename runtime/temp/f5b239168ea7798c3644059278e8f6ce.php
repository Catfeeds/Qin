<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/broadcast/update.html";i:1491876514;s:58:"D:\wwwroot\wchhui1\wwwroot/app/admin/view/public/base.html";i:1496904694;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<input type="hidden" name="aid" value="<?php echo $nobj['id']; ?>">
  ...
  <div class="layui-form-item" style="width:800px;display:none;">
    ...
    <div class="layui-input-block">
      <textarea id="content" name="content"  value="<?php echo $nobj['content']; ?>"> <?php echo $nobj['content']; ?></textarea>
    </div>
  </div>
