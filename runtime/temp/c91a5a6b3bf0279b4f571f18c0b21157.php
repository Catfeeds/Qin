<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\usercontrol\user_info.html";i:1492927450;s:67:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\ModelBase.html";i:1493095052;}*/ ?>
			  ...
			  <div class="layui-form-item">
				...
				<div class="layui-input-inline" id="cid" >
				  <select name="cid" required lay-verify="required" lay-filter="cit" style="width:200px;">
					 <option value="" >请选择</option>
					 <?php if(($obj['cid'] != 0)): if(is_array($clist) || $clist instanceof \think\Collection || $clist instanceof \think\Paginator): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cj): $mod = ($i % 2 );++$i;?>
