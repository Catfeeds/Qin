<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/user/photo.html";i:1500453726;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				...
				<a class="mui-control-item" href="<?php echo url('user/article'); ?>">动态</a>
				<a class="mui-control-item" href="<?php echo url('user/guestbook'); ?>">留言</a>
				<a class="mui-control-item mui-active" href="<?php echo url('user/photo'); ?>">相册</a>
			</div>
		</div>
		...
		<ul id="ajax_photo_return" class="mui-table-view mui-grid-view">
			...
			<li class="mui-table-view-cell mui-media mui-col-xs-6">
				<img class="mui-media-object" src="<?php echo $vo['img']; ?>" style="height: 165px;width: auto;">
...
<script type="text/javascript" charset="utf-8">
	...
	{ 
		...
		mui.alert(message,'提示','确定',function(){
			if(success) 
			{ 
				location.href='<?php echo url('user/photo'); ?>';
			}
		});
		...
		$('#ajax_photo_return').on('tap', 'a', function(event) {
			...
			mui.confirm('确认删除图片？', '通知信息', btnArray, function(e) {
				if (e.index == 0) {
					...
					mui.ajax('<?php echo url('User/photo_del'); ?>',{
						data:{id:id},
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
			page += 1;
			mui.ajax('<?php echo url('user/photo'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
