<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\school\add.html";i:1490504041;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1490686613;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-layout-admin">
    ...
    <div class="layui-side">
		<ul class="layui-nav layui-nav-tree">
		  ...
		  <li class="layui-nav-item">
			...
			<dl class="layui-nav-child">
			  ...
			  <dd><a href="<?php echo url('region/index'); ?>"><i class="layui-icon">&#xe602;</i>地区信息列表</a></dd>
			   ...
			   <dd><a href="<?php echo url('series/index'); ?>"><i class="layui-icon">&#xe602;</i>论坛分类列表</a></dd>
			</dl>
		  </li>
		  <li class="layui-nav-item">
		  ...
		  <li class="layui-nav-item">
			<a href="javascript:;"><i class="layui-icon">&#xe630;</i>论坛管理</a>
			<dl class="layui-nav-child">
			  <dd><a href="<?php echo url('module/index'); ?>"><i class="layui-icon">&#xe602;</i>论坛列表</a></dd>
			</dl>
		  </li>
		  <li class="layui-nav-item">
