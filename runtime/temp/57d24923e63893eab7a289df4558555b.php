<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/school/index.html";i:1497419978;s:56:"D:\wwwroot\wchhui1\wwwroot/app/wap/view/Public/base.html";i:1495342088;}*/ ?>
﻿<!DOCTYPE html>
<html>
	...
	<div class="mui-content">
		...
		<div style="padding: 10px 10px;">
			<div id="segmentedControl" class="mui-segmented-control">
				<a class="mui-control-item mui-active" href="<?php echo url('school/index'); ?>">校区集锦</a>
				<a class="mui-control-item" href="<?php echo url('school/index2'); ?>">热点时讯</a>
...
<script type="text/javascript" charset="utf-8">
	...
	mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/
			page += 1;
			mui.ajax('<?php echo url('School/index'); ?>',{
				data:{
					is_ajax:1,
					page:page
				},
