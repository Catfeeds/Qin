<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wwwroot\wchhui1\wwwroot/app/index/view/usercontrol/module_xlx.html";i:1496803472;s:63:"D:\wwwroot\wchhui1\wwwroot/app/index/view/public/ModelBase.html";i:1496552374;}*/ ?>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <ul class="layui-tab-title" id="LAY_mine">
        ...
        <li data-type="mine-jie" lay-id="index" class="layui-this">投稿修改</li>
      </ul>
          <form class="layui-form layui-form-pane"  style="padding: 20px 0;" action="" method="post" id="fid" enctype="multipart/form-data">
			  <div class="layui-form-item">
				...
				<div class="layui-input-block">
				  <input type="text" name="aname" value="<?php echo $obj['title']; ?>" placeholder="请输入名称" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item" pane>
			   ...
			   <div class="layui-form-item">
				...
				<div class="layui-input-block">
				  <input type="text" name="edit" value="<?php echo $obj['edit']; ?>" placeholder="请输入名称" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item">
				...
				<div class="layui-input-inline" id="tid">
				  <select name="tid" lay-filter="pir" style="width:200px;">
					 ...
					 <option value="1" <?php if($obj['tid']==1): ?>selected<?php endif; ?>>校园之声</option>
					 <option value="2" <?php if($obj['tid']==2): ?>selected<?php endif; ?>>校园院报</option>
			  ...
			  <div class="layui-form-item">
				...
				<div class="layui-input-inline" id="sid">
				  <select name="sid"  style="width:200px;">
					 <option value="" >请选择</option>
					 <?php if(is_array($slist) || $slist instanceof \think\Collection || $slist instanceof \think\Paginator): $i = 0; $__LIST__ = $slist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pj): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $pj['id']; ?>" <?php if($obj['sid']==$pj['id']): ?>selected<?php endif; ?>><?php echo $pj['name']; ?></option>
					 <?php endforeach; endif; else: echo "" ;endif; ?>
				  </select>
				</div>
			  </div>
			  <div class="layui-form-item layui-form-text" >
				...
				<div class="layui-input-block">
				  <textarea name="esc" value="<?php echo $obj['esc']; ?>" placeholder="请输入简介" class="layui-textarea" ><?php echo $obj['esc']; ?></textarea>
				</div>
			  </div>
			  <div class="layui-form-item layui-form-text" >
				<label class="layui-form-label">资讯内容</label>
				<div class="layui-input-block">
				  <textarea name="content" id="content" value="<?php echo $obj['content']; ?>"  placeholder="请输入内容" class="layui-textarea" ><?php echo $obj['content']; ?></textarea>
				</div>
			  </div>
