<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wwwroot\qnysj1\wwwroot/app/index/view/school/index.html";i:1499416870;s:57:"D:\wwwroot\qnysj1\wwwroot/app/index/view/public/Base.html";i:1520394624;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>校区集锦-<?php echo \think\Session::get('gjz.title'); ?></title>
...
<!-- 代码 结束 -->
		...
		<?php if(is_array($list_school) || $list_school instanceof \think\Collection || $list_school instanceof \think\Paginator): $i = 0; $__LIST__ = $list_school;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<div id="esc_<?php echo $i-1; ?>" style="<?php if(($i==1)): ?>display:block;<?php else: ?>display:none;<?php endif; ?>" class="school_introduce"><?php echo $vo['esc']; ?>... <a href="<?php echo url('school/school_info',['school_id'=>$vo['id']]); ?>" target="_blank">[详细]</a></div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
