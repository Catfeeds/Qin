<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\qnysj1\wwwroot/app/super_admin/view/ar/update.html";i:1498377324;s:63:"D:\wwwroot\qnysj1\wwwroot/app/super_admin/view/public/base.html";i:1498377698;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="" method="post" id="fid" enctype="multipart/form-data">
   <div class="layui-form-item" style="width:600px">
    ...
    <div class="layui-input-block">
      <select name="tid" required lay-verify="required" lay-filter="tid" style="width:200px;">
		 <option value="1" <?php if($obj['tid']=='1'): ?>selected<?php endif; ?>>关键字回复</option>
		 <option value="0" <?php if($obj['tid']=='0'): ?>selected<?php endif; ?>>默认回复</option>
      </select>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px" id="div0">
    ...
    <div class="layui-input-block">
      <select name="tname" required lay-verify="required" lay-filter="tname" style="width:200px;">
		 <option value="0" <?php if($obj['tname']=='0'): ?>selected<?php endif; ?>>回复文字</option>
		 <option value="1" <?php if($obj['tname']=='1'): ?>selected<?php endif; ?>>回复图文</option>
      </select>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px;<?php if($obj['tid']==0): ?>display:none;<?php endif; ?>" id="div1">
  ...
  <div class="layui-form-item" style="width:600px;<?php if($obj['tname']==0): ?>display:none;<?php endif; ?>" id="div2">
    <label class="layui-form-label">图文编码</label>
    <div class="layui-input-block">
      <input type="text" name="esc" lay-filter="esc" valu="<?php if($obj['tname']==1): ?><?php echo $obj['content']; endif; ?>" placeholder="请输入图文编码" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item" style="width:800px;<?php if($obj['tname']==1): ?>display:none;<?php endif; ?>" id="div3">
    <label class="layui-form-label">文字内容</label>
    <div class="layui-input-block">
	  <textarea name="content" style="width:600px;height:200px;"><?php if($obj['tname']==0): ?><?php echo $obj['content']; endif; ?></textarea>
    </div>
  </div>
