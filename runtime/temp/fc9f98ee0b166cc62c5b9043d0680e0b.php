<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\user\p_xx.html";i:1492499126;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493099283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
     <li onclick="javascript:window.location.href='<?php echo url('user/p_list',['id'=>$p['nid']]); ?>'">动态评论</li>
	<li class="layui-this">评论详细</li>
  </ul>
</div> 
<form class="layui-form" action="" method="post">
<input type="hidden" name="aid" value="<?php echo $p['id']; ?>">
<input type="hidden" name="nid" value="<?php echo $p['nid']; ?>">
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">用户名称</label>
    <div class="layui-input-block">
      <input type="text" name="aname" value="<?php echo $p['user_name']; ?>" lay-filter="aname"  autocomplete="off" class="layui-input" readonly>
    </div>
  </div>
  <div class="layui-form-item" style="width:600px">
    <label class="layui-form-label">评论内容</label>
    <div class="layui-input-block">
      <textarea name="content" class="layui-textarea" value="<?php echo $p['content']; ?>" readonly><?php echo $p['content']; ?></textarea>
    </div>
  </div>
