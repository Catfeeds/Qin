<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\school\art_list.html";i:1491626881;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1492494499;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <dl class="layui-btn-group">
		  <a href="<?php echo url('school/art_xx',['id'=>$vo['id']]); ?>" class="layui-btn">详细</a>
		  <a href="<?php echo url('school/z_list',['id'=>$vo['id']]); ?>" class="layui-btn">浏览记录</a>
		  <a href="<?php echo url('school/p_list',['id'=>$vo['id']]); ?>" class="layui-btn">评论记录</a>
	...
	form.on('switch(yyy)', function(data){
	  ...
	  if(data.elem.checked)
		...
		else
		{
			...
			$.ajax({
				url:"<?php echo url('school/art_update'); ?>",
				type:"post",
				dataType:"json",
	...
	function del(id)
	{
			layer.confirm('删除之后不可恢复，是否继续执行？', {
			  ...
			  btn1:function(index, layero){
					$.ajax({
					url:"<?php echo url('school/art_delete'); ?>",
					type:"post",
					dataType:"json",
					data:{aid:id},
					success:function(dd){
