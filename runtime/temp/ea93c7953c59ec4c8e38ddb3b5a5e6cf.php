<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\news\index.html";i:1491878168;s:62:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/admin\view\public\base.html";i:1493092171;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  <ul class="layui-tab-title">
    ...
    <li onclick="javascript:window.location.href='<?php echo url('news/insert'); ?>'">添加资讯</li>
  </ul>
</div> 
...
<table class="layui-table" lay-even>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php echo $vo['maxtype_name']; ?></td>
      ...
      <td >
		  <dl class="layui-btn-group">
			  <a href="<?php echo url('news/update',['id'=>$vo['id']]); ?>" class="layui-btn">编辑</a>
