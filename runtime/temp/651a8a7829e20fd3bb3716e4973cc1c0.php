<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\usercontrol\message.html";i:1492583732;s:67:"D:\amp\UPUPW_K2.1_64\htdocs\QN/app/index\view\public\ModelBase.html";i:1493095052;}*/ ?>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        ...
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
            ...
            <li >
			  <?php if(($vo['look'] == 0)): ?>
			  <a href="javascript:;"><i class="layui-icon" style="color: #00EE00;font-size: 25px;">&#xe623;</i></a>
			  <?php else: ?>
			  <a href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)"><i class="layui-icon" style="font-size: 25px;">&#x1006;</i></a>
			  <?php endif; ?>
			   <a href="<?php echo url('usercontrol/message_info',['message_id'=>$vo['id']]); ?>" target="_blank" ><?php echo $vo['title']; ?></a>
