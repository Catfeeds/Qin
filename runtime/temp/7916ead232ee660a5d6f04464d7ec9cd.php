<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/index/user_art_list.html";i:1502161610;s:55:"D:\wwwroot\qnysj1\wwwroot/app/wap/view/Public/base.html";i:1498016252;}*/ ?>
﻿<!DOCTYPE html>
<html>
...
mui("#getmore").on('tap','a',function(){
	 /*** ajax 提交表单 查询列表结果*/  
	page += 1;
	mui.ajax('<?php echo url('index/user_art_list'); ?>',{
		data:{
			user_id:id,
			is_ajax:1,
			page:page
